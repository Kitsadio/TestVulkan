...
const std::string MODEL_PATH = "models/cyli.obj";
const std::string MODEL_PATH1 = "models/cyl.obj";
const std::string TEXTURE_PATH = "textures/reel4.png";
...
private:
	...
	void updateUniformBuffer(uint32_t currentImage) {
		...
		ubo.view = glm::lookAt(glm::vec3(5.0f, 10.0f, 15.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 1.0f));
		ubo.proj = glm::perspective(glm::radians(45.0f), swapChainExtent.width / (float)swapChainExtent.height, 0.01f, 20.0f);
		ubo.proj[1][1] *= -1;
	...
	static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
		auto app = reinterpret_cast<Draw*>(glfwGetWindowUserPointer(window));
	...
	void createInstance() {
		...
		if (checkExtensions(extensions.data(), extensions.size()) != true) {
	...
	bool checkExtensions(const char** glfwExtensions, uint32_t glfwExtensionCount) {
